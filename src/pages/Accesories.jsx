...
const Accesories = () => {
  ...
  const applyFilter = () => {
    ...
    // Filter by category
    productsCopy = productsCopy.filter(item => item.category === 'Accessories');
  ...
  useEffect(() => {
    if (products.length > 0) {
      ...
      products.forEach(product => {
        if (product.category === 'Accessories' && product.brand && product.brand.trim() !== '') {
  ...
  if (products.filter(p => p.category === 'Accessories').length === 0) {
